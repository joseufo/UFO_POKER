...
namespace PokerSharp
{
    ...
    public static class EvaluateHand
    {
        ...
        public static int GetHighSingleCardRank(this List<Cardd> cards)
        {
        ...
        public static IOrderedEnumerable<KeyValuePair<int, int>> GetHighPairRank(this List<Cardd> cards)
        {
        ...
        public static HandRanking DetermineHandRankings(this List<Cardd> cards)
        {
        ...
        public static List<Cardd> SortCards(this IEnumerable<Cardd> cards)
        {
        ...
        public static IEnumerable<Cardd> SortCardsByRanking(this IEnumerable<Cardd> cards, HandRanking ranking)
        {
        ...
        public static bool CalculateStraight(this List<Cardd> cards)
        {
        ...
        public static IEnumerable<Cardd> SwapCardRank(this IEnumerable<Cardd> cards, int oldRank, int newRank)
        {

            var updatedCards = new List<Cardd>(cards);
            ...
            for (var i = 0; i < updatedCards.Count; i += 1)
            {
                ...
                if (updatedCards[i].rank == oldRank)
                {
                    ...
                    updatedCards[i] = new Cardd { suit = updatedCards[i].suit, rank = newRank };
        ...
        public static IEnumerable<KeyValuePair<int, int>> FindPairs(this List<Cardd> cards, string type = "rank")
        {
